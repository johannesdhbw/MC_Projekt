...
\newcommand{\titel}{Entwicklung eines CO$_2$-Messers zur Simulation einer automatisierten Fensteransteuerung}
...
\newcommand{\abgabe}{30.04.2020}
\newcommand{\zeitraum}{01.10.2019 - 30.04.2020}
...
\chapter{Projektplan}
\input{chapter/Projektplan}
\section{Arbeitsplan}
\input{chapter/Arbeitsplan}
\section{Aufgabenverteilung}
\input{chapter/Aufgabenverteilung}
\section{Kostenplan}
\input{chapter/Kostenplan}
\section{Cocomo}
\input{chapter/Cocomo}

\chapter{Entwurf}
\input{chapter/Entwurf}
\section{Architektur und Verhalten}
\input{chapter/ArchitekturundVerhalten}
\subsection{Zustandsdiagramm}
\input{chapter/Zustandsdiagramm}
\subsection{Top-Level-Architektur}
\input{chapter/Topleveldiagramm}
\subsection{Komponentendiagramm}
\input{chapter/Komponentendiagramm}
\section{Schaltungslayout}
\input{chapter/Schaltungslayout}
\section{Zeichnung des Computer-Aided Designs}
\input{chapter/CADZeichnung}
\section{3D-Druck}
\input{chapter/3D-Druck}

\chapter{Hardwarekomponenten}
\input{chapter/Komponenten}
\section{Arduino vs. Raspberry PI}
\input{chapter/ArduinovsRaspberryPI}
\section{Arduino}
\input{chapter/Arduino}
\section{CCS811}
\input{chapter/CCS811}
\section{Mikro-SD-Karten-Adapter}
\input{chapter/mikroSD}
\section{I$^2$C-Adapter}
\input{chapter/I2CAdapter}

\chapter{Softwareimplementierung}
\input{chapter/Softwareimplementation}

\chapter{Hardwareimplementierung}
\input{chapter/Hardwareimplementierung}

\chapter{Testing}
\input{chapter/Testing}

\chapter{Handbuch}
\input{chapter/Handbuch}
\section{Erste Schritte}
\input{chapter/ErsteSchritte}
\section{Durchführung einer Messung}
\input{chapter/MessungDurchfuehren}
\section{Auslesen einer Messung}
\input{chapter/MessungAuswerten}
\section{Sleepmode/Stromsparmodus}
\input{chapter/Sleepmode}
...
\section{Software}
\input{chapter/FazitSW}
\section{Hardware}
\input{chapter/FazitHW}

\chapter{Ausblick}
\input{Standard/Ausblick}
\section{Software}
\input{chapter/AusblickSW}
\section{Hardware}
\input{chapter/AusblickHW}
